...
public class ChatService {
    ...
    private String generateJSONStringForUIResponce(String message, Long driverId){
    ...
    public void sendNotification(String message, Long id){
        Message messageObject = new Message(message,  id, LocalDateTime.now(), new User(new Long(0)));
        messageRepository.save(messageObject);
        this.simpMessagingTemplate.convertAndSend(SOCKET_URL + id,
                this.generateJSONStringForUIResponce(message, id));
    }
