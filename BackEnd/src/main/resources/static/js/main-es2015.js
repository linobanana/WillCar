...
let MapService = class MapService {
    ...
    createRouteWithBalloonForUser(coordinates, driverName, driveStartTime, freeSeats) {
        ...
        children: [
            {
                ...
                children: [
                    ...
                    ..._admin_tab_admin_routes__WEBPACK_IMPORTED_MODULE_11__["AdminRoutes"]
                ]
            }
        ]
    }
...
let MapApiService = MapApiService_1 = class MapApiService extends _services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] {
    ...
    postInfoToSearchDrive(body) {
        return super.post(`api/drive/points`, body, MapApiService_1.mapDrives);
    }
};
...
let TripService = class TripService {
    constructor() {
        ...
        setTimeout(() => {
            this.drives = [_constants_trip__WEBPACK_IMPORTED_MODULE_3__["TEST_TRIP"]];
        }, 1000);
    }
    get tripsSubject() {
    ...
    cancelTrip(drive) {
        ...
        const tempTrips = Object(ramda__WEBPACK_IMPORTED_MODULE_4__["clone"])(this.drives);
