...
/* harmony import */ var _pages_personal_area_details_of_route_details_of_route_routes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/personal-area/details-of-route/details-of-route.routes */ "./src/app/pages/personal-area/details-of-route/details-of-route.routes.ts");
        /* harmony import */
        var _shared_components_succesful_create_route_successful_create_route_routes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/components/succesful-create-route/successful-create-route.routes */ "./src/app/shared/components/succesful-create-route/successful-create-route.routes.ts");
...
/* harmony import */ var _shared_api_profile_profile_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../shared/api/profile/profile.api.service */ "./src/app/shared/api/profile/profile.api.service.ts");
        ...
        /* harmony import */
        var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
let DetailsOfRouteComponent = class DetailsOfRouteComponent {
    ...
    ngOnInit() {
        ...
        (this.tripService.currentDrive, this.tripService.ifProposed)
...
let TripComponent = class TripComponent {
    ...
    hasDrives(archieved) {
        return this.drives && this.drives.filter((drive) = > drive.archive === archieved
    ).
        length;
    }
