...
/* harmony import */ var _pages_personal_area_admin_tab_admin_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./pages/personal-area/admin-tab/admin.module */ "./src/app/pages/personal-area/admin-tab/admin.module.ts");
        /* harmony import */
        var _shared_components_succesful_create_route_successful_create_route_module__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./shared/components/succesful-create-route/successful-create-route.module */ "./src/app/shared/components/succesful-create-route/successful-create-route.module.ts");
...
/* harmony import */ var _pages_personal_area_details_of_route_details_of_route_routes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/personal-area/details-of-route/details-of-route.routes */ "./src/app/pages/personal-area/details-of-route/details-of-route.routes.ts");
        /* harmony import */
        var _shared_components_succesful_create_route_successful_create_route_routes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/components/succesful-create-route/successful-create-route.routes */ "./src/app/shared/components/succesful-create-route/successful-create-route.routes.ts");
...
/* harmony import */ var _shared_constants_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/constants/common */ "./src/app/shared/constants/common.ts");
        ...
        /* harmony import */
        var _shared_components_user_user_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../shared/components/user/user.service */ "./src/app/shared/components/user/user.service.ts");
...
var MapService = /** @class */ (function () {
    function MapService(mapApi, router, userService, _ngZone) {
        this.mapApi = mapApi;
        this.router = router;
        this.userService = userService;
        ...
        multiRoute.events.add('update', function () {
            ...
            for (var i = 0; i < pathArray.getLength(); i++) {
                ...
                segments.each(function (segment) {
                    var index = segment.properties.get("lodIndex");
    ...
    MapService.prototype.exportDrive = function (form) {
        ...
        this.mapApi.postDrive(this.drive)
            .subscribe(function (data) {
                if (data != null) {
                    _this.router.navigate(['/success-create']);
                }
        });
    };
    MapService.prototype.getEndTime = function (startime) {
        if (this.duration !== undefined) {
            var tempdate = new Date(startime);
    ...
    MapService.prototype.createRouteWithBalloonForUser = function (drive) {
        ...
        var coordinates = drive.segmentsCoords;
        ...
        var temp = 0;
        var startCoords = coordinates[0];
        var endCoords = coordinates[coordinates.length - 1];
        ...
        var amount = drive.segmentsCoords.length / 70;
            ...
            multiRoute.events.add("click", function (event) {
                ...
                myPlacemark.balloon.open().then(function () {
                    ...
                    button.addEventListener('click', function () {
                        self_1._ngZone.run(function () {
                            self_1.router.navigate(['/confirmation']);
                        });
                    });
                });
            }, this_1);
    ...
    MapService.prototype.rotateToBookingsConfirm = function () {
        this.router.navigate(['/confirmation']);
    };
...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(profileApiService, fb) {
        this.profileApiService = profileApiService;
        this.fb = fb;
        this.users = [];
    ...
    AdminComponent.prototype.onSubmitForm = function () {
        var _this = this;
    ...
    AdminComponent.prototype.cleanValues = function () {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
        ...
        /* harmony import */
        var _shared_components_trip_trip_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/components/trip/trip.service */ "./src/app/shared/components/trip/trip.service.ts");
        /* harmony import */
        var _main_map_map_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../main/map/map.service */ "./src/app/pages/main/map/map.service.ts");
        /* harmony import */
        var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
        /* harmony import */
...
var DetailsOfRouteComponent = /** @class */ (function () {
    function DetailsOfRouteComponent(tripService, mapper, router) {
    ...
    DetailsOfRouteComponent.prototype.ngOnInit = function () {
        ...
        var self = this;
        var promise = new Promise(function (resolve, reject) {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(_this.tripService.currentDrive, _this.tripService.ifProposed)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1))
                .subscribe(function (_a) {
                    var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), drive = _b[0], ifProposed = _b[1];
                    if (drive === null) {
                        self.router.navigate(['/main']);
                        reject('update more info');
                    } else {
                        _this.drive = drive;
                        _this.ifProposed = ifProposed;
                        resolve(_this.drive);
                    }
                });
        });
        promise.then(function (result) {
            if (!_this.ifProposed) {
                _this.mapper.createRouteForMoreInformationBookings(_this.drive);
            }
            else {
                _this.mapper.createRouteForMoreInformationProposed(_this.drive);
            }
        }, function (error) {
            console.log(error);
        });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
        /* harmony import */
        var _main_map_map_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../main/map/map.service */ "./src/app/pages/main/map/map.service.ts");



var MiniMapComponent = /** @class */ (function () {
    function MiniMapComponent(mapService) {
        this.mapService = mapService;
    }
    ...
    MiniMapComponent.ctorParameters = function () {
        return [
...
var MyBookingsComponent = /** @class */ (function () {
    function MyBookingsComponent(tripService, userService) {
        ...
        tripService.getBookedDrives(this.userService.user.id).then(function () {
            _this.drives$ = tripService.bookedSubject;
        });
    }
...
var ProfileApiService = /** @class */ (function (_super) {
    ...
    ProfileApiService.prototype.getFilteredUsers = function (startTime, finTime) {
        return _super.prototype.get.call(this, "api/users/admin/startTime/" + startTime + "/finTime/" + finTime, ProfileApiService_1.mapUsers);
    };
...
var DriveApiService = /** @class */ (function (_super) {
    ...
    DriveApiService.prototype.postPassengerTrip = function (trip) {
        return _super.prototype.post.call(this, "api/passengerDrive/passenger", trip, DriveApiService_1.simpleResponse);
    };
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
        /* harmony import */
        var _trip_trip_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../trip/trip.service */ "./src/app/shared/components/trip/trip.service.ts");
        /* harmony import */
...
var InfoRouteComponent = /** @class */ (function () {
    function InfoRouteComponent(tripService, router) {
        this.tripService = tripService;
        this.router = router;
    }
    InfoRouteComponent.prototype.ngOnInit = function () {
        var _this = this;
        // const self = this;
        this.tripService.ifProposed.subscribe(function (ifProposed) {
            // if(ifProposed === null) {
            //   self.ngOnDestroy();
            // } else {
            _this.ifProposed = ifProposed;
    ...
    InfoRouteComponent.prototype.valid = function () {
    ...
    InfoRouteComponent.prototype.ngOnDestroy = function () {
    };
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
        /* harmony import */
        var _api_profile_profile_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../api/profile/profile.api.service */ "./src/app/shared/api/profile/profile.api.service.ts");
        /* harmony import */
        var _user_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../user/user.service */ "./src/app/shared/components/user/user.service.ts");
...
var ProfileMenuComponent = /** @class */ (function () {
    function ProfileMenuComponent(router, profileApiService, userService) {
        this.router = router;
        this.profileApiService = profileApiService;
        this.userService = userService;
...
/***/ }),
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__.d(__webpack_exports__, "SuccessfulCreateRouteComponent", function () {
            return SuccessfulCreateRouteComponent;
        });
        /* harmony import */
        ...
        /* harmony import */
        var _constants_labels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../constants/labels */ "./src/app/shared/constants/labels.ts");
        /* harmony import */
        var _constants_menu_items__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../constants/menu-items */ "./src/app/shared/constants/menu-items.ts");
        /* harmony import */
        ...
        var SuccessfulCreateRouteComponent = /** @class */ (function () {
            function SuccessfulCreateRouteComponent(router) {
                this.router = router;
            ...
            SuccessfulCreateRouteComponent.prototype.ngOnInit = function () {
            };
            SuccessfulCreateRouteComponent.prototype.goToMyProposed = function () {
                this.router.navigate(['/personalarea/', 'myproposed']);
            };
            SuccessfulCreateRouteComponent.prototype.goToMain = function () {
                this.router.navigate(['/main']);
            };
            SuccessfulCreateRouteComponent.ctorParameters = function () {
                return [
                    {type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]}
                ];
            };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "SuccessfulCreateRouteModule", function () {
            return SuccessfulCreateRouteModule;
        });
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        /* harmony import */
        ...
        /* harmony import */
        var _successful_create_route_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./successful-create-route.component */ "./src/app/shared/components/succesful-create-route/successful-create-route.component.ts");


        var SuccessfulCreateRouteModule = /** @class */ (function () {
            function SuccessfulCreateRouteModule() {
            }
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "SuccessfulCreateRouteComponentRoutes", function () {
            return SuccessfulCreateRouteComponentRoutes;
        });
        /* harmony import */
        var _successful_create_route_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./successful-create-route.component */ "./src/app/shared/components/succesful-create-route/successful-create-route.component.ts");

        var SuccessfulCreateRouteComponentRoutes = [
            {
                path: 'success-create',
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
        ...
        /* harmony import */
        var _trip_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./trip.service */ "./src/app/shared/components/trip/trip.service.ts");
...
var TripComponent = /** @class */ (function () {
    ...
    TripComponent.prototype.hasDrives = function (archieved) {
        return this.drives && this.drives.filter(function (drive) {
            return drive.archive === archieved;
        }).length;
    };
    TripComponent.prototype.emptyDriveList = function () {
        var _this = this;
        this.tripService.ifLoading.subscribe(function (ifLoading) {
            _this.ifLoading = ifLoading;
        });
        return (this.drives === null || this.drives.length === 0) && (this.ifLoading === false);
    };
    TripComponent.prototype.goToMain = function () {
        this.router.navigate(['/main']);
    };
...
var TripService = /** @class */ (function () {
    ...
    TripService.prototype.changeIfLoading = function (ifLoading) {
        this._ifLoadingSubject.next(ifLoading);
    };
    Object.defineProperty(TripService.prototype, "ifLoadingSubject", {
        get: function () {
