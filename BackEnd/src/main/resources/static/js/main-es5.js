...
/* harmony import */ var _shared_components_succesful_create_route_successful_create_route_routes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/components/succesful-create-route/successful-create-route.routes */ "./src/app/shared/components/succesful-create-route/successful-create-route.routes.ts");
...
var SuccessfulCreateRouteComponent = /** @class */ (function () {
    ...
    SuccessfulCreateRouteComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var TripComponent = /** @class */ (function () {
    ...
    TripComponent.prototype.hasDrives = function (archieved) {
        return this.drives && this.drives.filter(function (drive) { return drive.archive === archieved; }).length;
    };
